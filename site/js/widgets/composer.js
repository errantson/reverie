...
class ComposerWidget {
    constructor(options = {}) {
        this.options = {
            ...
            mode: options.mode || 'compose' // 'compose' or 'edit'
        };
                                ...
                                <div class="compose-text-full">
                                    <div class="compose-text-header">
                                        <div class="compose-text-title">
                                            ...
                                            ${this.options.mode === 'edit' ? 'Edit Dream' : 'Compose Dream'}
                                        </div>
                                    ...
                                    <!-- View toggle buttons - bottom left of container -->
                        ...
                        <div class="compose-footer">
                            ...
                            <div class="compose-footer-right">
                                ...
                                <button class="compose-footer-btn compose-footer-btn-primary" id="composerSubmitBtn" onclick="window.currentComposer?.${this.options.mode === 'edit' ? 'saveEdit' : 'post'}()">
                                    ${this.options.mode === 'edit' ? 'Save' : 'Post Now'}
                                </button>
                            </div>
                        </div>
                    </div>
    ...
    async post() {
        ...
        try {
            ...
            if (this.scheduledDate) {
                ...
                // Immediate post - TODO: implement direct posting
                alert('Immediate posting not yet implemented in composer modal. Please use the main compose tab.');
                return;
            }
            ...
            if (submitBtn) {
                ...
                submitBtn.textContent = this.scheduledDate ? 'Schedule Post' : 'Post Now';
            }
        }
    }
